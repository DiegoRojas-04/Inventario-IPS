                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-3">
                        <select name="categoria" class="form-control" id="categoria" onchange="this.form.submit()">
                            ...
                            <option value="Monitores" {{ request('categoria') == 'Monitores' ? 'selected' : '' }}>Monitores</option>
                            <option value="Tablets" {{ request('categoria') == 'Tablets' ? 'selected' : '' }}>Tablets</option>
                            <option value="Televisores" {{ request('categoria') == 'Televisores' ? 'selected' : '' }}>Televisores</option>
                            <option value="Telefonos" {{ request('categoria') == 'Telefonos' ? 'selected' : '' }}>Teléfonos</option>
                            <option value="Mause" {{ request('categoria') == 'Mause' ? 'selected' : '' }}>Mause</option>
                            <option value="Teclados" {{ request('categoria') == 'Teclados' ? 'selected' : '' }}>Teclados</option>
                                    ...
                                    <form action="{{ route('elementos.update.observacion', $activo->id) }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="observacion" class="form-control"
                                                value="{{ $activo->observacion }}" placeholder="Escribe una observación">
                                        </div>
                                        <div class="modal-footer">
