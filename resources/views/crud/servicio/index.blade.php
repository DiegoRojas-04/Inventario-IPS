    ...
    <div class="card-header">
        <div class="row g-3">
            ...
            <div class="col-md-1">
                ...
                <form id="filterForm" method="GET" action="{{ url('/servicio') }}">
            ...
            <div class="col-md-5 input-group">
                <form id="searchForm" method="GET" action="{{ url('/servicio') }}" class="d-flex w-100">
                    <input type="text" class="form-control" name="search" placeholder="Buscar Servicio..." value="{{ request('search') }}">
